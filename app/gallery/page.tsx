...
export const metadata: Metadata = {
  title: 'معرض أعمال الحدادة | أفضل حداد في جدة',
  description: 'تصفح سابقة أعمالنا وصور مشاريع الحدادة والكريتال في مدينة جدة. أعمال مميزة لتفصيل الأبواب، الشبابيك، الدرابزين، والمظلات بإشراف أفضل حداد بجدة.',
};
