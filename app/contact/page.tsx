    ...
    <div className="bg-stone-50 pb-24">
      <div className="bg-white py-20 border-b border-stone-200 text-center">
        <ScrollReveal className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-stone-500 text-lg max-w-2xl mx-auto">نحن هنا للإجابة على استفساراتكم وتلقي طلباتكم على مدار الساعة.</p>
        </ScrollReveal>
      </div>
          ...
          <ScrollReveal delay={0.3} className="bg-stone-900 rounded-3xl p-10 text-white relative overflow-hidden flex flex-col justify-center text-center shadow-2xl h-full">
             ...
             <div className="relative z-10">
               ...
               <a 
                  ...
                  className="inline-flex justify-center items-center gap-3 bg-amber-500 text-stone-900 px-8 py-5 rounded-2xl font-bold text-xl transition-all hover:bg-amber-400 hover:scale-105 mb-4 w-full sm:w-auto"
                >
                  <Phone size={24} />
                  <span>اتصل الآن</span>
                </a>
                ...
                <a 
                  ...
                  className="inline-flex justify-center items-center gap-3 bg-white/10 text-white px-8 py-5 rounded-2xl font-bold text-xl transition-all hover:bg-white/20 w-full sm:w-auto mt-4 sm:mt-0 sm:mr-4 backdrop-blur-sm"
                >
