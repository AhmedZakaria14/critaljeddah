          ...
          <div className="flex justify-between items-center h-24">
            <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 group cursor-pointer">
              <div className="relative w-16 h-16 md:w-20 md:h-20">
                <Image sizes="80px" src={logoUrl} alt="حداد كريتال جدة" fill className="object-contain" referrerPolicy="no-referrer" priority />
              </div>
            ...
            <div className="hidden xl:flex gap-8 text-sm font-bold tracking-wide">
              {navLinks.map((link) => (
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="hidden xl:flex items-center gap-3 bg-stone-100 border border-stone-200 text-stone-800 px-6 py-3 rounded-full font-bold hover:bg-white hover:border-amber-200 transition-all shadow-sm hover:shadow-md group"
              >
              ...
              <button
                ...
                className="xl:hidden text-stone-800 p-2 focus:outline-none focus:ring-2 focus:ring-amber-500 rounded-lg transition-colors"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div id="mobile-menu"
            ...
            className="fixed inset-0 z-40 bg-white pt-24 xl:hidden flex flex-col"
          >
